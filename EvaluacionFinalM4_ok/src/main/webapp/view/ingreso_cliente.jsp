    ...
    <div class="container-fluid pt-lg-5">
        <div class="row mt-4">
            <div class="col-12 text-center my-5 my-lg-0 px-4">
              <h2>El usuario tipo cliente ha sido ingresado correctamente</h2>
            </div>
        </div>
    </div>
    <!-- Tabla -->
        ...
        <table class="table table-bordered border-secondary table-striped text-center">
            ...
            <tbody>
            	<c:forEach var="c" items="${ cliente }">
                	<tr>
                		<th scope="row">
                			<c:out value="${ c.getRutEmpresa() }"></c:out>
                		</th>
                		<td>
                			<c:out value="${ c.getRazonSocial() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ c.getDireccion() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ c.getComuna() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ c.getCantidadEmpleados() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ c.getTelefono() }"></c:out>
                		</td>
                	</tr>	
                </c:forEach>
            </tbody>
