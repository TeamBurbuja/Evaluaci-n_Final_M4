...
<head>
	...
	<title>USUARIO PROFESIONAL</title>
</head>
...
<body>
	...
	<div class="container-fluid">
		<div class="row py-5">
			...
			<div
				...
				<h2 class="display-6 mb-5">Usuario Profesional</h2>
				<form id="formulario" action="ProfesionalServlet" method="POST">
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="fecha" class="form-label">Fecha de Ingreso</label> <input
	...
	<div id="footer"
		...
		<img class="logotipo" src="img/Safety Logo H WHITE.png" alt="logotipo">
	</div>
	<!-- Scripts -->
	<script src="lib/bootstrap_5/js/bootstrap.min.js"></script>
    ...
    <script src="view/js/crear_profesional.js"></script>
