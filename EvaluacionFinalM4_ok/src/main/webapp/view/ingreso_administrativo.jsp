    ...
    <div class="container-fluid pt-lg-5">
        <div class="row mt-4">
            <div class="col-12 text-center my-5 my-lg-0 px-4">
              <h2>El usuario tipo administrativo ha sido ingresado correctamente</h2>
            </div>
        </div>
    </div>
    <!-- Tabla -->
    <div class="container-fluid table-responsive py-5 px-4 pb-lg-5 my-4 text-center">
        <table class="table table-bordered border-secondary table-striped text-center">
            <thead class="border-secondary">
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Nombre de Superior</th>
            ...
            <tbody>
            	<c:forEach var="a" items="${ administrativo }">
                	<tr>
                		...
                		<td>
                			<c:out value="${ a.getNombreSuperior() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ a.getArea() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ a.getFuncion() }"></c:out>
                		</td>
                		<td>
                			<c:out value="${ a.getExperienciaPrevia() }"></c:out>
                		</td>
                	</tr>	
                </c:forEach>
            </tbody>
