...
<body>
    ...
    <div class="container-fluid">
        <div class="row py-5">
            ...
            <div class="col-12 col-lg-6 order-first mb-5 mb-lg-0 order-lg-last p-4 p-lg-5">
                <h2 class="display-6 mb-5">Agendar Capacitación</h2>
                <form id="formulario" action="RegistrarCapacitacionServlet" method="POST">
					<div class="mb-3">
						<label for="id" class="form-label">ID</label> <input
							type="number" name="id" class="form-control" id="id">
					</div>
					<div class="mb-3">
						<label for="rut" class="form-label">RUT Cliente</label> <input
							type="text" name="rut" class="form-control" id="rut">
					</div>
					<div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="hora" class="form-control" id="hora" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="duracion" class="form-control" id="duracion">
                    </div>
                    <div class="mb-3">
                        <label for="asistentes" class="form-label">Cantidad Asistentes</label>
                        <input type="number" name="asistentes" class="form-control" id="asistentes">
                    </div>
                    <button type="submit" class="btn btn-primary px-5">Ingresar</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="view/js/crear_capacitacion.js"></script>
