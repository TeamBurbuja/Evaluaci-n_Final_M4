...
<body>
	...
	<div class="container-fluid table-responsive py-5 px-4 p-lg-5 my-lg-5">
		...
		<p>
			ID: <c:out value="${ u.getId() }"></c:out>
		</p>
		<p>
			RUN: <c:out value="${ u.getRun() }"></c:out>
		</p>
		<p>
			FECHA: <c:out value="${ u.getFechaNacimiento() }"></c:out>
		</p>
		<p>
			NOMBRE: <c:out value="${ u.getNombre() }"></c:out>
		</p>
		<p>
			TIPO: <c:out value="${ u.getTipoUsuario() }"></c:out>
		</p>
	</div>
	<!-- Info Usuarios -->
