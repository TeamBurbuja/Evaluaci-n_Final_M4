					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<li><a class="dropdown-item activo" aria-current="page"
	...
	<div class="container-fluid">
		<div class="row py-5">
			...
			<div
				...
				<h2 class="display-6 mb-5">Usuario Cliente</h2>
				<form id="formulario" action="ClienteServlet" method="POST">
					<div class="mb-3">
						<label for="rut_empresa" class="form-label">RUT Empresa</label> <input
							type="text" class="form-control" name="rut_empresa"
							id="rut_empresa" placeholder="XXXXXXXX-Y">
					</div>
					<div class="mb-3">
						<label for="razon" class="form-label">Razón Social</label> <input
							type="text" class="form-control" name="razon" id="razon">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="c_empleados" class="form-label">Cantidad de
							Empleados</label> <input type="number" class="form-control"
							name="c_empleados" id="c_empleados">
					</div>
					<div class="mb-3">
