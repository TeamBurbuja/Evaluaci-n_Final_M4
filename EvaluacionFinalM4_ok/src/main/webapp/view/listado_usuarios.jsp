...
<body>
    ...
    <div class="container-fluid table-responsive py-5 px-4 p-lg-5 my-lg-5">
        ...
        <h3 class="text-center display-6 mb-5"><a href="CrearUsuarioServlet"><i class="fas fa-user-plus"></i></a></h3>
        <table class="table table-responsive table-bordered table-striped border-secondary text-center" id="tabla">
            <thead>
                <tr>
              		<th scope="col">ID</th>
            ...
            <tbody>
                <c:forEach var="u" items="${ usuarios }">
                	<tr>
                		...
                		<td>
                			<c:out value="${ u.getNombre() }"></c:out>
                		</td>
                		<td>
							<c:out value="${ u.getFechaNacimiento() }"></c:out>               			
                		</td>
                		<td>
                			<c:url var="ancla" value="/EditarUsuarioServlet">
                				<c:param name="run" value="${ u.getRun() }"></c:param>
                				<c:param name="result" value="ver"></c:param>
                			</c:url>
                			<%-- <a href="${ ancla }"> --%>
                				<c:out value="${ u.getRun() }"></c:out>
                			<!-- </a> -->
                		</td>
                		<td>
                			<c:out value="${ u.getTipoUsuario() }"></c:out>
                		</td>
                		<td>
                			<c:url var="accion" value="/EditarUsuarioServlet">
                				<c:param name="run" value="${ u.getRun() }"></c:param>
                				<c:param name="result" value="edit"></c:param>
                			</c:url>
                			<a href="${ accion }"><i class="fas fa-edit"></i></a>
    ...
    <script src="view/js/listado_usuarios.js"></script>
