...
<title>USUARIO ADMINISTRATIVO</title>
</head>
...
<body>
	...
	<div class="container-fluid">
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="InicioServlet"> <img
					class="logotipo" src="view/img/Safety Logo H.png" alt="logotipo">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link" href="InicioServlet">Home</a>
						</li>
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item"
									href="CrearCapacitacionServlet">Crear Capacitación</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								<li><a class="dropdown-item"
									href="ListarCapacitacionesServlet">Listar Capacitaciones</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
							</ul>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle activo" href="#"
							id="navbarDropdown" role="button" data-bs-toggle="dropdown"
							aria-expanded="false"> Usuarios </a>
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item" href="LoginServlet">Iniciar
										Sesión</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								...
								<li><a class="dropdown-item" href="ListadoUsuariosServlet">Listar
										Usuarios</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
					...
					<div>
						<button class="btn btn-danger mb-3 mb-md-0 ms-lg-4" type="submit">
	...
	<div class="container-fluid">
		<div class="row py-5">
			...
			<div
				class="col-12 col-lg-6 order-first mb-5 mb-lg-0 order-lg-last p-4 p-lg-5">
				<h2 class="display-6 mb-5">Usuario Administrativo</h2>
				<form id="formulario" action="AdministrativoServlet" method="POST">
					<div class="mb-3">
						<label for="id" class="form-label">ID</label> <input type="number"
							class="form-control" name="id" id="id">
					</div>
					<div class="mb-3">
						<label for="nombre_superior" class="form-label">Nombre de
							Superior</label> <input type="text" class="form-control"
							name="nombre_superior" id="nombre_superior">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="funcion" class="form-label">Función</label> <input
							type="text" class="form-control" name="funcion" id="funcion">
					</div>
					<div class="mb-3">
						<label for="exp_previa">Experiencia Previa</label>
						<textarea class="form-control"
							placeholder="Comente sobre su experiencia..." name="exp_previa"
							id="exp_previa"></textarea>
					</div>
					<button type="submit" class="btn btn-primary px-5">Crear
						Usuario</button>
				</form>
			</div>
		</div>
	...
	<div id="container-home" class="container-fluid py-5">
		<h3 class="text-center text-primary fw-bold my-4">¿Qué procesos
			considera la plataforma actualmente?</h3>
		<div class="row">
			<div class="col-md-6 text-center my-5">
				<i class="far fa-address-card display-5 mb-3"></i>
				<h3>Registro de usuarios</h3>
				<p>Permite ingreso de usuarios: Cliente, profesional y
					administrativo</p>
			</div>
			<div class="col-md-6 text-center my-5">
				<i class="fas fa-exclamation-triangle display-5 mb-3"></i>
				<h3>Registro de ocurrencias</h3>
				<p>Manejo de data respectiva a accidentes realacionados al
					cliente</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-center my-5">
				...
				<p>Manejo de visitas, capacitaciones y asesorías con sus
					respectivas mejoras</p>
			</div>
			<div class="col-md-6 text-center my-5">
	...
	<script src="view/js/administrativo.js"></script>
